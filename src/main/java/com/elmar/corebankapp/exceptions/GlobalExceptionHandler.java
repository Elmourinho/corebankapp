...
import com.elmar.corebankapp.constants.HttpResponseConstants;
import com.elmar.corebankapp.errors.ConstraintsViolationError;
...
public class GlobalExceptionHandler extends DefaultErrorAttributes {
	...
	public ResponseEntity<Map<String, Object>> handle(CoreBankException ex, WebRequest request) {
	...
	protected ResponseEntity<Map<String, Object>> ofType(WebRequest request,
			HttpStatus status, CoreBankException ex) {
